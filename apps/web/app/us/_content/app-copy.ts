...
export const appCopy = {
  ...
  account: {
    ...
    brokerHeld:
      "Held: this record is for a live Alpaca account. Closed Alpha supports paper accounts only. Nothing is read from it and no action can use it; the record is kept as evidence.",
