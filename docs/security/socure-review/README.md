...
| [`security-training-package.md`](security-training-package.md)                 | 15–20 minute training content + 10-question acknowledgment quiz (v1)                                                                                                   | POLICY ADOPTED, ORGANIZATIONAL ACTION PENDING (no completion recorded) |
...
| [`endpoint-verification-2026-09-10.md`](endpoint-verification-2026-09-10.md)   | Read-only verification of the founder's development Mac (FileVault/Gatekeeper/XProtect/SIP/updates PASS; firewall OFF and 2-hour idle lock FAIL; several manual items) | PARTIALLY VERIFIED — organizational control NOT YET COMPLETE           |
...
| [`vulnerability-scan.md`](vulnerability-scan.md)                               | Scan report — baseline external DAST of the three public hosts, 2026-09-10                                                                                             | IMPLEMENTED (no findings above informational)                          |
...
| Security awareness training      | **NO FOR NOW**                   | `security-awareness-policy.md`, `security-training-package.md`, `training-completion-checklist.md` | Policy and 15–20 min package exist; no person is recorded complete. Flips to YES when the checklist is filled.                                                                             |
...
| Endpoint security                | **NO FOR NOW**                   | `endpoint-security-baseline.md`, `endpoint-verification-2026-09-10.md`                             | One device checked read-only: firewall off and 2-hour idle lock FAIL; remediation steps listed; re-check and other devices pending.                                                        |
| Vulnerability scanning           | **YES** (baseline external scan) | `vulnerability-scan.md`                                                                            | Non-intrusive nuclei baseline of refi.trading, demo and bff-dev on 2026-09-10; 0 medium/high/critical; not a penetration test; dependency audit runs in CI report-only; gitleaks blocking. |
