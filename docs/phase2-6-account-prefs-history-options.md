...
**Status:** **Architecture ratified by Daniel (2026-05-30): Option 3c — hybrid TS/Python split.** Backend ownership of `AccountPrefsHistory` confirmed by Daniel (2026-05-30): the table lives in Daniel's Spanner instance; Daniel will set up the table and backend wiring. Frontend mock interfaces are authorized in the interim per PR-D. Production Surface 4 remains blocked; mock Surface 4 is allowed after PR-D lands.
