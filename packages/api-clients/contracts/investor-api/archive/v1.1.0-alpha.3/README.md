# ReFinity frontend integration package v1.1.0-alpha.3

This supersedes alpha.2 for new integration. All 41 route methods and request/
response field definitions remain unchanged. Error profiles now describe actual
