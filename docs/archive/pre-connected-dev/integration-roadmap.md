...
> Archived September 12, 2026. Historical planning only; use the
> [current integration checklist](../../integration-roadmap.md). The percentages,
> deployment targets and Signal/Admin Portal plan below are not current instructions.
